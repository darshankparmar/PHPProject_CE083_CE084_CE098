...
CREATE TABLE `categories` (
  ...
  `categorieDesc` varchar(255) NOT NULL,
...
(14, 'CHICKEN SAUSAGE', 199, 'Chicken Sausage I Cheese', 2, '2021-03-17 21:35:31'),
...
--
ALTER TABLE `categories`
  MODIFY `categorieId` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `pizza`
--
ALTER TABLE `pizza`
  MODIFY `pizzaId` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
